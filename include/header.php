...
?>
 | <a href="search.php?<?=$select_arg?>"><img src="../common/images/icon_search.gif">検索</a>
 | <a href="list.php?page=0&<?=$select_arg?>"><img src="../common/images/icon_list.gif">リスト</a>
 | <a href="addnew.php?type=0&<?=$select_arg?>" onClick="return confirm('船データを作成します。よろしいですか？')"><img src="../common/images/icon_addnew.gif">船登録</a>
 | <a href="addnew.php?type=1&<?=$select_arg?>" onClick="return confirm('エンジンを作成します。よろしいですか？')"><img src="../common/images/icon_addnew.gif">エンジン登録</a>
<?php if (!$select_mode) { ?>
 | <a href="search2.php"><img src="../common/images/icon_search.gif">検査検索</a>
 | <a href="list2.php?page=0"><img src="../common/images/icon_list.gif">検査リスト</a>
<?php } ?>
<?php
	break;
case 5:
