...
$field = "$base.*";
$field .= ", sales_h.ID as sid, work_h.ID as wid";
...
echo_form_frame_end();
echo_form_frame("運転時間");
echo_form_tr($rs, "左エンジン", "mainte15", "hour");
echo_form_tr($rs, "右エンジン", "mainte16", "hour");
echo_form_tr($rs, "発電機", "mainte17", "hour");
echo_form_frame_end();
...
echo_form_tr($rs, "見積有効期限", "mainte18", "date");
...
//		location.href="../sales/addnew.php?mid=<?=$id?>";
		document.form1.sales_addnew.value = <?=$id?>;
