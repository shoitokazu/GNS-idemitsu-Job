...
function echo_detail() {
	global $i,$f,$kubun, $col, $client_charset;

	$f2 = mb_strimwidth($f[2], 0, 25, "", $client_charset);
	$f3 = mb_strimwidth($f[3], 0, 25, "", $client_charset);
?>
<tr>
<td align=center><?=$i?></td>
<td nowrap><?=$f[1]?></td>
<td nowrap><?=html_format($f2, "str")?></td>
<td nowrap><?=html_format($f3, "str")?></td>
