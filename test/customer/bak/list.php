...
$table = "customer";
$flag = DListUp("value,name", "choices", "field='customer_flag'", "sort");
if ($flag==false) $flag = array();
$group = DListUp("value,name", "choices", "field='customer_group'", "sort", true);
...
<?php
	...
	echo_html_td($rs, "address", "str");
	echo_html_td($rs, "cname2", "str");
	echo_html_td($rs, "kana2", "str");
	echo_html_td($rs, "address2", "str");
	foreach ($flag as $v) {
