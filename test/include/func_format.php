...
function echo_search_input($field, $type="str", $default="") {
	...
	switch ($type) {
	default:
		echo "<input type='text' name='$f1' value='$v1'>";
		break;
	case "hidden":
		echo "<input type='hidden' name='$f1' value='$v1'>";
		break;
	case "default":
		echo "<input type='hidden' name='$f1' value='$default'>";
		break;
	case "str":
		echo "<input class='str' type='text' name='$f1' value='$v1'>";
		break;
	case "int":
		echo "<input class='num' type='text' name='$f1' value='$v1'>";
		break;
	case "ccode":
		echo "<input type='text' name='$f1' value='$v1' id='ccode'>";
		echo_button_customer("ccode");
		break;
	case "mcode":
		echo "<input type='text' name='$f1' value='$v1' id='mcode'>";
		echo_button_machine("mcode");
		break;
	case "fcode":
		echo "<input type='text' name='$f1' value='$v1' id='fcode'>";
		echo_button_figure("fcode", "fcode");
		break;
	case "icode":
		echo "<input type='text' name='$f1' value='$v1' id='icode'>";
		echo_button_item("icode", "icode");
		break;
	case 'estimate':
		echo "<input type='radio' name='$f1' value='1'".($v1==1 ? " checked" : "").">見積書$rn";
		echo "<input type='radio' name='$f1' value='0'".($v1==0 ? " checked" : "")." id='".$f1."_default'>整備明細書$rn";
		break;
	case "date":
		...
		echo ' <input type="checkbox" name="'.$f0.'" value=1'.($v0==1 ? " checked" : "").'>未記入';
		break;
	case 'radio':
...
function echo_common_report_group($rs) {
