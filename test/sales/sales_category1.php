...
$query2 .= " and (sales_state=0 or sales_state=1 or sales_state=2)";
$query2 .= $groupBy;
...
$query3 .= " and (sales_state=0 or sales_state=1 or sales_state=2)";
$query3 .= $groupBy;
...
$query4 .= " and (sales_state=0 or sales_state=1 or sales_state=2)";
$query4 .= $groupBy;
