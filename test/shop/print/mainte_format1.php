...
<?php	switch ($customer_type) {
	default:
?>
<div style="width:310px;height:20px;overflow:hidden;"><?=$sc_html?></div>
<div style="width:310px;height:100px;overflow:hidden;">
...
<div align=left style="width:230px;height:110px;overflow:hidden;">
<?=$stamp?>
</div>
...
<div class="border">
<table>
<tr><td width=40 align=center>検印</td></tr>
